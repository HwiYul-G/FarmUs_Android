 ...
 */
class CompletedEnrollFarmerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_completed_enroll_farmer, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            CompletedEnrollFarmerFragment().apply {
